...
export default function Home() {
  return (
    <>
      {/* <Header /> */}
      <main className="mt-[193] flex min-h-[100%] flex-col items-center space-y-6 pt-10 px-18">
        <Image
        ...
        <p class={classNames("text-md w-full text-center px-18")}>
          No need to miss out on all our awesome food and your favorite bottle
          or can of beer/cider! <br></br>Come on in to order take out or call
          your order in at 415.252.7704
        </p>
